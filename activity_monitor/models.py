...
# this really should be in the app config, but it creates import problems in older versions
# because it tries to import django.apps. So we have to put it here.
